    ...
    return (
        <div className="main-container">
            ...
            <div className="four-5-grid">
                ...
                <div className="four-5-grid-content" id="box-grid-3">
                ...
                <div className="four-5-grid-content" id="box-grid-6">
                ...
                <div className="four-5-grid-content" id="box-grid-7">
                ...
                <div className="four-5-grid-content" id="box-grid-8">
                ...
                <div className="four-5-grid-content" id="box-grid-9">
                ...
                <div className="four-5-grid-content" id="box-grid-10">
